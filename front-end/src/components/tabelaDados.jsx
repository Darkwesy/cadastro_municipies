      ...
      {showAlert == true && (
        ...
        >
          <Alert>
            ...
            <AlertDescription>
              Exclusão do registro concluida com sucesso!
            </AlertDescription>
          </Alert>
        </div>
      )}
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-1/3 border-l border-zinc-200 sm:pl-6">
                Bairro / Logradouro / Rua
              </TableHead>
              <TableHead className="w-1/3 sm:w-1/12 border-l border-zinc-200 sm:pl-4">
                Ações
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {data
              ...
              .map((item) => (
                <TableRow
                  className="cursor-pointer text-sm sm:text-sm md:text-base lg:text-base"
                  key={item.id}
                >
                  <TableCell className="border-r border-zinc-200">
                    <div className="flex flex-col sm:flex-row items-start justify-between sm:items-center sm:gap-4">
                      ...
                      <p className="text-gray-500 dark:text-gray-400 sm:pr-6">
                        {item.cpf}
                      </p>
                    </div>
                  </TableCell>
